...
describe('sayHiToHeadphonedRoommate(string)', function() {
  it('returns "I can\'t hear you!" if `string` is lowercase', function() {
    ...
    function sayHiToHeadphonedRoommate(string) { if (string.toLowerCase() === string) { return "I can't hear you!"; }
}
  })
  ...
  function sayHiToHeadphonedRoommate(string) { if (string === string.toUpperCase()) { return "YES INDEED!"; }
}
  ...
  it('returns "I would love to!" if `string` is "Let\'s have dinner together!"`', function () {
    ...
    function sayHiToHeadphonedRoommate(string) { if (string === "Let's have dinner together!") { return "I would love to!"; }
}
  });
})
